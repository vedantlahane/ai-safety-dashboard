...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-blue-200 to-purple-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-all duration-500 relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="relative z-10  py-6 text-center border-t border-gray-300 dark:border-gray-700 bg-gradient-to-t from-gray-100 to-transparent dark:from-gray-800 dark:to-transparent">
        <div className="max-w-5xl mx-auto px-4">
          <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-700 dark:text-gray-300 text-sm md:text-left">
              ...
              as part of a project to improve AI safety monitoring. Interested
              in more of my work on web development?
            </p>
            <a
              href="https://vedantlahane.vercel.app"
              target="_blank"
